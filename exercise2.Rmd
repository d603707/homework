...
The models used were Naive Bayes and PCA multinomial logistic regression. The PCA method had a 32% accuracy on the test data while the Naive Bayes had a 61% accuracy.Sidenote: couldn't get the PCA to use more than 15 vectors for multinomial. Thus, Naive Bayes was a better method to use. 
